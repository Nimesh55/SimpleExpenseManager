...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean addTransaction(Transaction transaction){
        ...
        cv.put(COLUMN_DATE, dateFormatter.format(transaction.getDate()));
        cv.put(COLUMN_ACCOUNT_NO,transaction.getAccountNo());
        cv.put(COLUMN_EXPENSE_TYPE, String.valueOf(transaction.getExpenseType()));
        cv.put(COLUMN_AMOUNT, decimalFormat.format(transaction.getAmount()));
    ...
    public boolean addAccount(Account account){
        ...
        cv.put(COLUMN_BALANCE, decimalFormat.format(account.getBalance()));
    ...
    public List<Transaction> getAllTransactionLogs(){
        ...
        if(cursor.moveToFirst()){
            do {
                ...
                double amount = Double.parseDouble(decimalFormat.format(cursor.getDouble(4)));
    ...
    public Map<String, Account> getAllAccounts(){
        ...
        if(cursor.moveToFirst()){
            do {
                ...
                Double balance = Double.valueOf(decimalFormat.format(cursor.getDouble(3)));
